...
begin
  ...
  try
    ...
    if Assigned(FDataset) and FDataSet.IsEmpty then
      raise Exception.Create(FMSG.MSGnotGet);
  end;
end;
...
begin
  try
    ...
    if Assigned(FDataset) and FDataSet.IsEmpty then
      raise Exception.Create(FMSG.MSGnotGet) else
...
begin
  ...
  try
    ...
    raise Exception.Create(FMSG.MSGokPost);
  end;
end;
...
begin
  ...
  try
    ...
    FConexao.Commit;
    raise Exception.Create(FMSG.MSGokPut);
  end;
end;
...
begin
 ...
 try
  try
   ...
   FConexao.Commit;
   raise Exception.Create(FMSG.MSGokDelete);
 end;
end;
